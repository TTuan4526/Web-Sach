...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <input type="number" name="number" required placeholder="Nhập SDT" class="box">
      <textarea name="message" class="box" placeholder="Nhập lời nhắn của bạn" id="" cols="30" rows="10"></textarea>
