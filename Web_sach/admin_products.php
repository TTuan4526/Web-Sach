...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      $message[] = 'Sản phẩm này đã được thêm vào hệ thống!';
   }else{
      $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, price, image) VALUES('$name', '$price', '$image')") or die('query failed');

      if($add_product_query){
         if($image_size > 2000000){
            $message[] = 'size file ảnh quá lớn';
         }else{
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <!-- tạo box nhập hình ảnh sản phẩm -->
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <!-- tạo button cập nhật sản phẩm -->
         <a href="admin_products.php?update=<?php echo $fetch_products['id']; ?>" class="option-btn">Cập nhật</a>
         <!-- tạo button xóa sản phẩm -->
         <a href="admin_products.php?delete=<?php echo $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('Có chắc chắn xóa sản phẩm này?');">Xóa</a>
      </div>
      <?php
         }
      }else{
